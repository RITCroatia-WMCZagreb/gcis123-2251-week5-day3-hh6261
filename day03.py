...
def names_and_addresses_01(filename:str):
    with open(filename) as csv_file:
        ##Header will be "Last Name,First Name,Lab 1,Lab 2,Lab 3,Lab 4,Lab 5,Lab 6,Lab 7,Lab 8,Exam 1,Exam 2,Proj 1,Proj 2-1,Proj 2-2,Proj 2-3,Proj 2-4,Final Grade"
        header = next(csv_file)##skipping first line, 
